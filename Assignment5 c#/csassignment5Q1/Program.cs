...
namespace ConsoleApp3
{
    internal class Class1
    {
        public static void Main()
        {
            ...
            string[] pavani = new string[3];
            String[] alli = new String[3];
            for (int j = 0; j < pavani.Length; j++)
            {
                Console.WriteLine("Enter string elements:");
                pavani[j] = Console.ReadLine();
            }
            Console.WriteLine("List of string elements:");

            foreach (string j in pavani)
            {
                Console.WriteLine(j);
            }
            Console.ReadKey();
